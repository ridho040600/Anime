...
var button = document.getElementById("tombol");
        ...
        var input = document.getElementById("search").value;
          ...
          fetch("https://api.jikan.moe/v3/search/manga?q="+input)
...
function preview(){
            console.log(' ');
            fetch('https://api.jikan.moe/v3/top/manga/1/manga').then(response => response.json())
              .then((data) => { 
                  for(var i=0; i<10; i++){
                              document.getElementById("result").innerHTML+=
                              "<div class='col-md-3 mb-4'>"+
          ...
          function keluar(pilihan){
            ...
            console.log(' '); 
            fetch("https://api.jikan.moe/v3/genre/manga/"+pilihan+"/1")
                    .then(Response => Response.json())
                    .then(data => {
                      for(var i=0; i<16; i++){
                        document.getElementById("hasil").innerHTML+=
